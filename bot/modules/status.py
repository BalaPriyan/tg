...
<i>Tip: Use /{BotCommands.StatusCommand[0]} me to see your tasks only</i>
"""
...
<b>Speed</b>
Down: {get_readable_file_size(dl_speed)}/s
Up: {get_readable_file_size(up_speed)}/s
Seed: {get_readable_file_size(seed_speed)}/s
"""
        button = ButtonMaker()
